...
export default function DialogSelect() {
  ...
  return (
    <div>
      ...
      <img onClick={handleClickOpen} src={(country==="TW")?TaiwanFlag:AmericaFlag} alt="countrySelect"></img>
      </Tooltip>
      <Dialog disableBackdropClick disableEscapeKeyDown open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <FormControl className={classes.formControl}>
              ...
              >
                <MenuItem value="TW"><img src={TaiwanFlag} style={{width:"2rem"}} alt="countrySelect"></img>&nbsp;Taiwan(Traditional Chinese)</MenuItem>
                <MenuItem value="US"><img src={AmericaFlag} style={{width:"2rem"}} alt="countrySelect"></img>&nbsp;America(English)</MenuItem>
              </Select>
            </FormControl>
